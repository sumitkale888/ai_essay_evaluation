                ...
                <table className="w-full text-left">
                    <thead className="bg-gray-50 border-b">
                        <tr>
                            ...
                            <th className="p-5 font-bold text-gray-600">Plagiarism</th>
                            <th className="p-5 font-bold text-gray-600">Possible Source</th>
                            <th className="p-5 font-bold text-gray-600">Status</th>
                        </tr>
                    </thead>
                    <tbody>
                        {submissions.length === 0 && (
                            <tr><td colSpan="5" className="p-10 text-center text-gray-400">No submissions found for this topic.</td></tr>
                        )}
                        {submissions.map((sub, i) => (
                            <tr key={i} className="border-b last:border-0 hover:bg-blue-50/30 transition">
                                <td className="p-5 font-bold text-gray-800">{sub.student_name || sub.name}</td>
                                <td className="p-5">
                                ...
                                <td className="p-5">
                                    <span
                                        className={`text-sm font-medium italic ${
                                            sub.is_plagiarized ? 'text-red-600' : 'text-gray-500'
                                        }`}
                                    >
