        ...
        <div className="max-w-7xl mx-auto p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-2">
                    <h2 className="text-xl font-bold mb-6 text-blue-700 uppercase tracking-wider">Available Essay Topics</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {topics.map((topic) => (
                            <div key={topic.topic_id} className="bg-gradient-to-br from-white to-blue-50 p-6 rounded-2xl shadow-md border border-blue-100 flex flex-col justify-between hover:shadow-lg transition-shadow">
                                <div>
                                ...
                                <Link 
                                    ...
                                    className="w-full text-center bg-blue-600 text-white py-3 rounded-xl font-bold hover:bg-blue-700 transition shadow-sm"
                                >
                                    Write Essay
                                </Link>
                            </div>
                ...
                <div className="bg-gradient-to-b from-white to-cyan-50/70 p-6 rounded-3xl border border-cyan-100 shadow-sm">
                    ...
                    <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
                        ...
                        {history.map((item, i) => (
                            <div key={i} className="bg-white p-4 rounded-2xl shadow-sm border-l-4 border-blue-500 border border-slate-100">
